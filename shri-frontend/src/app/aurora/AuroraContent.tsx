...
We don't.`,
  ...
  {
    title: "The Belief",
    content: `Aurora began with a simple belief:
...
Aurora exists because we believe personal computing deserves a different future. Not a future built around corporations. Not a future built around advertising. Not a future built around extracting as much value as possible from the people who depend on technology every day.
...
Aurora is being built with that principle at its foundation.`,
  },
  {
...
Aurora is our attempt to prove that.`,
  },
  {
...
Aurora is designed around that idea.

Not to demand attention. But to earn trust.`,
  },
  {
    title: "Why Aurora Exists",
    content: `Aurora is not being built because the world needs another Linux distribution.

The world already has enough operating systems.

Aurora exists because we believe there is still room for a better relationship between people and technology.
...
And Aurora is our commitment to building it.`,
  },
];
...
export default function AuroraContent() {
  return (
    <motion.div
    ...
    >
      <motion.div variants={itemVariants} className="mb-24 text-center">
        ...
        <h1 className="text-7xl md:text-9xl font-thin tracking-tight text-white mb-6">
          <span className="italic metallic-text font-light">Aurora</span>
        </h1>
          ...
          >
            ...
            <div className="space-y-4 text-gray-400 font-light leading-relaxed tracking-wide text-sm md:text-base max-w-3xl">
              {section.content.split("\n\n").map((paragraph, i) => (
                <p key={i} className={paragraph.startsWith("Aurora") && paragraph.endsWith("it.") ? "text-shri-gold/80 italic" : ""}>
                  {paragraph}
                </p>
              ))}
            </div>
      ...
      >
        <div className="max-w-2xl mx-auto">
          ...
          <p className="mt-12 text-gray-600 text-[10px] uppercase tracking-[0.5em]">
            Aurora - A SHRI Ecosystem Project
          </p>
        </div>
      </motion.div>
      ...
      <motion.div variants={itemVariants} className="mt-40 text-center">
        <div className="max-w-lg mx-auto glass rounded-[2.5rem] p-16 border border-shri-gold/20 relative overflow-hidden">
          ...
          <p className="text-gray-500 text-xs uppercase tracking-[0.4em] font-light max-w-sm mx-auto leading-loose">
            Aurora is currently in development. We are crafting a new paradigm for personal computing.
          </p>
