...
import DynamicAstera from "./DynamicAstera";
...
export default function AsteraShowcase() {
  return (
    <section id="astera" className="py-40 px-8 relative overflow-hidden bg-shri-black">
      <DynamicAstera />
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-10">
          <Card
            ...
            desc="Every layer of Astera is architected so privacy is never optional — it is the foundation. Your data belongs to you, always."
            delay={0.1}
            icon={
          ...
          <Card
            ...
            desc="Technology that fades into the background. Astera is built to earn trust, not demand attention — helping you create without friction."
            delay={0.5}
            icon={
              <svg className="w-6 h-6 text-shri-gold" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="1.5">
